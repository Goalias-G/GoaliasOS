package com.goalias.chat.mcp.service.impl;
...
import com.goalias.chat.mapper.McpInfoMapper;
...
public class McpInfoServiceImpl implements McpInfoService {
     ...
     */
    @Override
    public McpInfo queryById(Integer mcpId) {
        return baseMapper.selectById(mcpId);
    }
         ...
         */
        @Override
        public TableDataInfo<McpInfo> queryPageList(McpInfoBo bo, PageQuery pageQuery) {
            LambdaQueryWrapper<McpInfo> lqw = buildQueryWrapper(bo);
            Page<McpInfo> result = baseMapper.selectPage(pageQuery.build(), lqw);
     ...
     */
    @Override
    public List<McpInfo> queryList(McpInfoBo bo) {
        LambdaQueryWrapper<McpInfo> lqw = buildQueryWrapper(bo);
