...
public class ThreadPoolConfig {
    ...
    /**
     * 核心线程数 = cpu 核心数 * 2 (IO 密集型)
     */
    private final int core = Runtime.getRuntime().availableProcessors();

    @Primary
    @Bean(name = "osThreadPool")
    public ThreadPoolTaskExecutor osThreadPool(ThreadPoolProperties threadPoolProperties) {
        ...
        executor.setThreadNamePrefix("osThreadPool-");
        return executor;
    }
