...
import com.goalias.domain.SysConfig;
import com.goalias.domain.bo.SysConfigBo;
import com.goalias.mapper.SysConfigMapper;
import com.goalias.service.ISysConfigService;
...
public class SysConfigServiceImpl implements ISysConfigService {
    ...
    @Override
    public TableDataInfo<SysConfig> selectPageConfigList(SysConfigBo config, PageQuery pageQuery) {
     ...
     */
    @Override
    public List<SysConfig> selectConfigList(SysConfigBo config) {
        LambdaQueryWrapper<SysConfig> lqw = buildQueryWrapper(config);
    ...
    public String updateConfig(SysConfigBo bo) {
        ...
        if (config.getConfigId() != null) {
            ...
            if (!StringUtils.equals(temp.getConfigKey(), config.getConfigKey())) {
                redisService.del(CacheNames.SYS_CONFIG + ":" + temp.getConfigKey());//TODO 检查cache缓存
            }
    ...
    public void deleteConfigByIds(Long[] configIds) {
        for (Long configId : configIds) {
            ...
            redisService.del(CacheNames.SYS_CONFIG + ":" + config.getConfigKey());
        }
    ...
    public void resetConfigCache() {
        redisService.del(CacheNames.SYS_CONFIG);
    }
