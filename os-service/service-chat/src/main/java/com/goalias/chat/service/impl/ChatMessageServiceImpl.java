...
public class ChatMessageServiceImpl implements IChatMessageService {
     ...
     */
    @Override
    public TableDataInfo<ChatMessage> queryPageList(ChatMessageBo bo, PageQuery pageQuery) {
        ...
        Page<ChatMessage> result = baseMapper.selectPage(pageQuery.build(), lqw);
     ...
     */
    @Override
    public List<ChatMessage> queryList(ChatMessageBo bo) {
        LambdaQueryWrapper<ChatMessage> lqw = buildQueryWrapper(bo);
