...
public interface IKnowledgeAttachService {
     ...
     * 查询知识库附件
     */
    KnowledgeAttach queryById(Long id);

    /**
     * 查询知识库附件列表
     */
    TableDataInfo<KnowledgeAttach> queryPageList(KnowledgeAttachBo bo, PageQuery pageQuery);

    /**
     * 查询知识库附件列表
     */
    List<KnowledgeAttach> queryList(KnowledgeAttachBo bo);
